...
# Notificador — presupuesto diario de llamadas eBay y defaults de la franja activa.
# El tope duro de eBay Browse es 5000/día (subible a 50000 vía Growth Check).
EBAY_LLAMADOS_DIARIOS_MAX = int(os.getenv('EBAY_LLAMADOS_DIARIOS_MAX', '5000'))
NOTIFICADOR_VENTANA_INICIO_DEFAULT = os.getenv('NOTIFICADOR_VENTANA_INICIO_DEFAULT', '07:00')
NOTIFICADOR_VENTANA_FIN_DEFAULT = os.getenv('NOTIFICADOR_VENTANA_FIN_DEFAULT', '01:00')
NOTIFICADOR_OBJETIVO_DEFAULT = int(os.getenv('NOTIFICADOR_OBJETIVO_DEFAULT', '5000'))
NOTIFICADOR_RESERVA_DEFAULT = int(os.getenv('NOTIFICADOR_RESERVA_DEFAULT', '200'))